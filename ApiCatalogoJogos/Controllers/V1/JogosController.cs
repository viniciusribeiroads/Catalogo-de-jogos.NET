...
{
    [Route("api/V1/[controller]")] //indicando caminho da controller
    [ApiController] //indicando o tipo 
    public class JogosController : ControllerBase //herdando da controller base
    {
